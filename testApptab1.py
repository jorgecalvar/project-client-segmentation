...
app.layout = html.Div(
    children= [
                ...
                html.Div(  # Bloque izquierdo
                    children=[
                        ...
                        html.Div(  # filtros centro
                            children=[
                                dcc.RangeSlider(
                                    ...
                                    id='Age_slider_1'),
                                dcc.RangeSlider(
                                    min=min(df_selectedvariables.days_enrolled), max=max(df_selectedvariables.days_enrolled),
                                    value=[min(df_selectedvariables.days_enrolled), max(df_selectedvariables.days_enrolled)],
                                    tooltip={"placement": "bottom", "always_visible": True},
                                ...
                                dcc.RangeSlider(
                                    ...
                                    id='Income_slider_1'),
                                dcc.RangeSlider(
                                    min=min(df_selectedvariables.Total_Spent), max=max(df_selectedvariables.Total_Spent),
                                    value=[min(df_selectedvariables.Total_Spent), max(df_selectedvariables.Total_Spent)],
                                    tooltip={"placement": "bottom", "always_visible": True},
                        ...
                        html.Div(  # filtros derecha
                            children=[
                                dcc.RangeSlider(
                                    min=min(df_selectedvariables.NumAllPurchases), max=max(df_selectedvariables.NumAllPurchases),
                                    value=[min(df_selectedvariables.NumAllPurchases), max(df_selectedvariables.NumAllPurchases)],
                                    tooltip={"placement": "bottom", "always_visible": True},
                                ...
                                dcc.RangeSlider(
                                    min=min(df_selectedvariables.ShareDealsPurchases), max=max(df_selectedvariables.ShareDealsPurchases),
                                    value=[min(df_selectedvariables.ShareDealsPurchases), max(df_selectedvariables.ShareDealsPurchases)],
                                    tooltip={"placement": "bottom", "always_visible": True},
                                    id='ShareDealsPurchases_slider_1'),
                                dcc.RangeSlider(
                                    min=min(df_selectedvariables.kidsteenHome),max=max(df_selectedvariables.kidsteenHome),
                                    value=[min(df_selectedvariables.kidsteenHome),max(df_selectedvariables.kidsteenHome)],
                                    step=1,
                                    tooltip={"placement": "bottom", "always_visible": True},
        ...
        html.Div(  # segunda fila
            children=[
                html.Div(  # Bloque abajo Izquierda
                    children=[
                        html.Div(  # filtros 1
                            children=[
                                dcc.Dropdown(
