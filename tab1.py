...
-Kidhome: children in  household
-Teenhome: teenagershousehold
-Dt_Customer: Date of customer's 
enrollment with the company
-Recency: Number of days since 
customer's last purchase
-Complain: 1 if the customer 
complained in the last 2 years,
All below in last 2 years:
-MntWines: Amount spent on wine 
-MntFruits: Amount spent on fruits 
-MntMeatProducts:  on meat 
-MntFishProducts:  on fish 
-MntSweetProducts: on sweets 
-MntGoldProds: on gold 
-NumDealsPurchases: N of purchases
 made with discount
-AcceptedCmpX: 1 if offer accepted 
in the X campaign
-Response: 1if offer accepted  in 
the last campaign
